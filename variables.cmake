...
# Effect Presets (named configs over the scripts)
if (WIN32)
    set(EFFECTPRESETDIR "EffectPresets")
elseif (APPLE)
    set(EFFECTPRESETDIR "${DATADIR}/EffectPresets")
else ()
    set(EFFECTPRESETDIR "${DATADIR}/effectpresets")
endif ()

# Look Bundles (portable palette-stack snapshots)
if (WIN32)
    set(BUNDLEDIR "Bundles")
elseif (APPLE)
    set(BUNDLEDIR "${DATADIR}/Bundles")
else ()
    set(BUNDLEDIR "${DATADIR}/bundles")
endif ()
