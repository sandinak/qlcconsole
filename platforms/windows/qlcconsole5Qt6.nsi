...
OutFile "qlcconsole_5.1.1.exe"
InstallDir C:\qlcconsole5
...
Section "qlcconsole" SEC_MAIN
	...
	StrCmp $R1 ">" skip
		...
		CreateShortCut '$SMPROGRAMS\$R0\qlcconsole.lnk' $INSTDIR\qlcconsole-qml.exe
...
Section "Associate .qxw and .qxf files" SEC_ASSOC
	...
	WriteRegStr HKCU "Software\Classes\QLCConsole.Document\shell\open\command" "" '"$INSTDIR\qlcconsole-qml.exe" --open "%1"'

	WriteRegStr HKCU "Software\Classes\.qxf" "" "QLCConsoleFixture.Document"
	WriteRegStr HKCU "Software\Classes\QLCConsoleFixture.Document" "" "qlcconsole Fixture"
	WriteRegStr HKCU "Software\Classes\QLCConsoleFixture.Document\DefaultIcon" "" "$INSTDIR\qlcconsole-qml.exe,0"
	WriteRegStr HKCU "Software\Classes\QLCConsoleFixture.Document\shell\open\command" "" '"$INSTDIR\qlcconsole-qml.exe" --open "%1"'
...
Section "Uninstall"
	...
	Delete $INSTDIR\qlcconsole-qml.exe
	Delete $INSTDIR\*.dll
	...
	DeleteRegKey HKCU "Software\Classes\QLCConsoleFixture.Document"
